...
def create_pdf(export_data):
    ...
    page.drawString(36, height - 174, f'Voor {export_data["period"]["label"]} is dit het bedrag dat je volgens Rekenrust waarschijnlijk moet betalen of terugkrijgt.')
    ...
    page.drawString(56, 178, "Hoe leest Rekenrust dit?")
    page.setFillColor(muted)
    page.setFont("Helvetica", 9)
    page.drawString(56, 157, "1. Eerst telt Rekenrust de btw op verkoopfacturen mee die niet meer op concept staan.")
    page.drawString(56, 138, "2. Daarna trekt Rekenrust de btw af die je op zakelijke kosten hebt betaald.")
