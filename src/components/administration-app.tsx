...
function VatOverview({ vat }: { vat: VatSummary }) {
  const isPayable = vat.payableVatCents >= 0;
  const resultText = isPayable ? "waarschijnlijk betalen" : "waarschijnlijk terugkrijgen";
  ...
  return <>
    ...
    <section className={isPayable ? "vat-hero card" : "vat-hero vat-hero-refund card"}>
      <div><p className="eyebrow">BELANGRIJKSTE BEDRAG</p><h2>Je moet {resultAmount} {resultText}.</h2><p>Dit is het verschil tussen de btw op je verkoopfacturen en de btw op je zakelijke kosten.</p></div>
