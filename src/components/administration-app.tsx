...
function Settings({ onSaved, onLoggedOut }: { onSaved: (settings: CompanySettings) => void; onLoggedOut: () => void }) {
  ...
  useEffect(() => {
    async function loadSettings() {
      ...
      if (response.ok && data.settings) setForm(data.settings);
