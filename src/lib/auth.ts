...
type SessionUser = { id: string; name: string; email: string; companyName: string; emailVerified: boolean };
...
type SupabaseUserRow = { id: string; name: string; email: string; company_name: string; email_verified_at: string | null };
...
export async function getSessionUser(): Promise<SessionUser | null> {
  ...
  if (usesSupabaseStorage()) {
    ...
    const user = await supabaseSingle<SupabaseUserRow>("users", {
